...
const canModerateVoucher = (voucher) =>
...
const VoucherAdmin = () => {
  ...
  const handleApproveVoucher =
    async () => {
      ...
      if (
        approveAdminVoucher.fulfilled.match(
          result,
        )
      ) {
        toast.success(
  ...
  const handleRejectVoucher =
    async (event) => {
      ...
      if (
        rejectAdminVoucher.fulfilled.match(
          result,
        )
      ) {
        toast.success(
  ...
  return (
    <div className="voucher-admin">
      ...
      {approveTarget && (
        <div
          className="voucher-admin__modal-backdrop"
          role="presentation"
        >
          <div
